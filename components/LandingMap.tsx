...
export default function LandingMap() {
  ...
  return (
    <div className="relative w-full h-[600px] rounded-2xl overflow-hidden shadow-2xl z-10">
      ...
      <div className="absolute bottom-4 right-4 z-[1001]">
        <button className="bg-gradient-to-r from-[#9b2247] to-[#611232] text-white px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center space-x-2">
